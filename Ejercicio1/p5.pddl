(define (problem ascensor-problema-5)
    ...
    (:init
        ...
        (capacidad_ascensor ascensor-rapido1 capacidad1)
        (capacidad_ascensor ascensor-rapido2 capacidad1)
        (capacidad_ascensor ascensor-lento-b1 capacidad3)
        (capacidad_ascensor ascensor-lento-b2-1 capacidad3)
        (capacidad_ascensor ascensor-lento-b2-2 capacidad3)
        (capacidad_ascensor ascensor-lento-b3 capacidad3)
