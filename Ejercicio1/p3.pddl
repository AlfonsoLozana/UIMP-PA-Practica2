(define (problem ascensor-problema-3)
    ...
    (:init
        ...
        (en_planta pasajero1 planta0)
        (en_planta pasajero2 planta0)
        (en_planta pasajero3 planta0)
        (en_planta pasajero4 planta0)
        (en_planta pasajero5 planta0)
        (en_planta pasajero6 planta0)
    ...
    (:goal
        (and
            (en_planta pasajero0 planta12)
            (en_planta pasajero1 planta12)
            (en_planta pasajero2 planta12)
            (en_planta pasajero3 planta12)
            (en_planta pasajero4 planta12)
            (en_planta pasajero5 planta12)
