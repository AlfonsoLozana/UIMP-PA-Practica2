(define (problem ascensor-problema-5)
    ...
    (:init
        ...
        (= (plazas_libres ascensor-rapido1) 1)
        (= (plazas_libres ascensor-rapido2) 1)
        (= (plazas_libres ascensor-lento-b1) 3)
        (= (plazas_libres ascensor-lento-b2-1) 3)
        (= (plazas_libres ascensor-lento-b2-2) 3)
        (= (plazas_libres ascensor-lento-b3) 3)
